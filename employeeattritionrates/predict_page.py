...
def show_predict_page():
	...
	yrs_former_company = st.text_input('***Years at Former Company*** (Enter a Whole Number)')
	age = st.text_input('***Age*** (Enter a Whole Number)')
	income = st.text_input('***Monthly Income Offered*** (Enter a Whole Number)')
	companies_worked = st.text_input('***Number of Companies Worked*** (Enter a Whole Number)')
