...
def show_predict_page():
	...
	yrs_former_company = st.text_input('Years at Former Company')
	age = st.text_input('Age')
	income = st.text_input('Monthly Income Offered')
	companies_worked = st.text_input('Number of Companies Worked')
